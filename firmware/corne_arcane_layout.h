...
// parent's directory. Keep this file shared
// by griffin_anim and griffin_hostoled so the Vial and host branches cannot
// silently drift at their typing layer boundary.
