...
void test_build_host_packet(uint8_t type, uint32_t session, uint16_t sequence, uint8_t scene,
                            uint8_t notification_count, uint8_t category, uint8_t priority,
                            uint8_t age, bool persistent, uint8_t civic, uint8_t secondary,
