...
enum {
    DUEL_M12_DENSITY_SINGLE = 0, // 1 notification
    DUEL_M12_DENSITY_FEW    = 1, // 2-4
    DUEL_M12_DENSITY_MANY   = 2, // 5+
};
...
// m12_visitor_state_t field packing (Wave 6 owns it per the §16.1 note):
//   kind_target     : bits0-2 courier kind (DUEL_M12_COURIER_*), bit3 city (0 L / 1 R)
//   lifecycle_phase : DUEL_M12_VISIT_*
//   progress_flags  : bits0-1 density bucket (DUEL_M12_DENSITY_*), bit2 persistent
...
// result is packed into shared_pres via m12_visitor_shared_pres().
