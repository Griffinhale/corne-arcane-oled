...
void duel_combat_draw_wizard(duel_fb_t *fb, bool casting, int facing,
                             uint8_t variant, int xo, int yo);
...
void duel_combat_draw_charge(duel_fb_t *fb, const duel_view_wizard_t *wz,
                             int facing, uint32_t frame);
...
void duel_overlay_draw_health(duel_fb_t *fb, const duel_view_wizard_t *wz,
                              bool is_left);
void duel_overlay_draw_local_fx(duel_fb_t *fb, const duel_render_t *r,
                                const duel_view_wizard_t *wz, int facing,
                                bool is_left);
